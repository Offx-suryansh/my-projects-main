            ...
            <div className="container mx-auto px-8 lg:flex">
              <div className="text-center lg:text-left lg:w-1/2">
                <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">
                 Intelligent Cryptocurrency Market Insights

                </h1>
                <p className="text-xl lg:text-2xl mt-6 font-light">
                  Access real-time cryptocurrency prices, market capitalization,
and trend analysis through a fast, reliable, and intuitive platform.
                ...
                <p className="mt-4 text-gray-600">
                 Built with React.js and real-time crypto APIs
            ...
            <div className="container mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
                <div className="flex-1 px-3">
                  ...
                  >
                    <p className="font-semibold text-xl">Real-Time Cryptocurrency Price Tracking</p>
                    <p className="mt-4">
                      Get instant access to live cryptocurrency prices with real-time updates,
ensuring accurate and up-to-date market information at all times.
                ...
                <div className="flex-1 px-3">
                  <div
                    ...
                    style={{ boxShadow: "0 10px 28px rgba(0,0,0,.08)" }}
                  >
                    <p className="font-semibold text-xl">Market Trends and Performance Analytics</p>
                    <p className="mt-4">
                     Analyze cryptocurrency market trends, price movements, and performance
metrics to gain deeper insights and make informed decisions.
                ...
                <div className="flex-1 px-3">
                  <div
                    ...
                    style={{ boxShadow: "0 10px 28px rgba(0,0,0,.08)" }}
                  >
                    <p className="font-semibold text-xl">Multi-Currency Support</p>
                    <p className="mt-4">
                     Track and compare prices of multiple cryptocurrencies across the market,
including major and emerging digital assets, in one unified platform.
